...
function makeMiddleEarth() {
	...
	section.id = "midde-earth"
	// this was just a long to see if our section was made properly(it was !)
	// console.log((section)
	...
	for (i = 0; i < lands.length; i++){
		...
		// we have an article, we have a name, now we tell our program to keep them together, with appenChild
...
function makeHobbits() {
	...
	//or const theShire = document.querySelector('#The-Shire')
